...
describe("Safemoon", () => {
  ...
  const percentOptimize = (int1: number, int2: number): string => {
    return "=============> Optimize " + (int1 / int2) * 100 + "% gas than for old";
  };
  ...
  //   console.log("\x1b[36m%s\x1b[0m", "Transfer from exclude to non-exclude wallet", percentOptimize(gasLimit.toNumber(), oldGasLimit.toNumber()));
  //
  //
  ...
  //   console.log("\x1b[36m%s\x1b[0m", "gasLimit", gasLimit.toString());
  //   console.log("\x1b[36m%s\x1b[0m", "oldGasLimit", oldGasLimit.toString());
  //   console.log("\x1b[36m%s\x1b[0m", "Transfer from non-exclude to non-exclude wallet", percentOptimize(gasLimit.toNumber(), oldGasLimit.toNumber()));
  //
  //
  //   await safemoon.transfer(account1.address, parseEther("10"));
  //   await oldSafemoon.transfer(account1.address, parseEther("10"));
  ...
  //   console.log("\x1b[36m%s\x1b[0m", "gasLimit", gasLimit.toString());
  //   console.log("\x1b[36m%s\x1b[0m", "oldGasLimit", oldGasLimit.toString());
  //   console.log("\x1b[36m%s\x1b[0m", "Transfer from non-exclude to exclude wallet: ", percentOptimize(gasLimit.toNumber(), oldGasLimit.toNumber()));
  //
  //
  //   await safemoon.transfer(account1.address, parseEther("10"));
  //   await oldSafemoon.transfer(account1.address, parseEther("10"));
  ...
  //   console.log("\x1b[36m%s\x1b[0m", "gasLimit", gasLimit.toString());
  //   console.log("\x1b[36m%s\x1b[0m", "oldGasLimit", oldGasLimit.toString());
  //   console.log("\x1b[36m%s\x1b[0m", "Transfer from exclude to exclude wallet: ", percentOptimize(gasLimit.toNumber(), oldGasLimit.toNumber()));
  //
  //
  //   await safemoon.transfer(account1.address, parseEther("10"));
  //   await oldSafemoon.transfer(account1.address, parseEther("10"));
  ...
  //   console.log("\x1b[36m%s\x1b[0m", "gasLimit", gasLimit.toString());
  //   console.log("\x1b[36m%s\x1b[0m", "oldGasLimit", oldGasLimit.toString());
  //   console.log("\x1b[36m%s\x1b[0m", "TransferFrom from exclude to non-exclude wallet", percentOptimize(gasLimit.toNumber(), oldGasLimit.toNumber()));
  //
  //
  ...
  //   console.log("\x1b[36m%s\x1b[0m", "gasLimit", gasLimit.toString());
  //   console.log("\x1b[36m%s\x1b[0m", "oldGasLimit", oldGasLimit.toString());
  //   console.log("\x1b[36m%s\x1b[0m", "TransferFrom from non-exclude to non-exclude wallet", percentOptimize(gasLimit.toNumber(), oldGasLimit.toNumber()));
  //
  //
  //   await safemoon.connect(account2).transferFrom(deployer.address, account1.address, parseEther("10"));
  //   await oldSafemoon.connect(account2).transferFrom(deployer.address, account1.address, parseEther("10"));
  ...
  //   console.log("\x1b[36m%s\x1b[0m", "gasLimit", gasLimit.toString());
  //   console.log("\x1b[36m%s\x1b[0m", "oldGasLimit", oldGasLimit.toString());
  //   console.log("\x1b[36m%s\x1b[0m", "TransferFrom from non-exclude to exclude wallet", percentOptimize(gasLimit.toNumber(), oldGasLimit.toNumber()));
  //
  //
  //   await safemoon.connect(account2).transferFrom(deployer.address, account1.address, parseEther("10"));
  //   await oldSafemoon.connect(account2).transferFrom(deployer.address, account1.address, parseEther("10"));
  ...
  it("transferFrom from exclude to exclude wallet", async () => {
    ...
    // add deployer to exclude
    await safemoon.transfer(account2.address, parseEther("1000"));
    await oldSafemoon.transfer(account2.address, parseEther("1000"));
    await safemoon.excludeFromReward(account1.address);
    await oldSafemoon.excludeFromReward(account1.address);
    await safemoon.excludeFromReward(account2.address);
    await oldSafemoon.excludeFromReward(account2.address);

    const amountLimit = 5000 * 10 ** 6 * 10 ** 9 - 1;
    //
    const acc1SFMBalance = await safemoon.balanceOf(account1.address);
    const acc1OldSFMBalance = await oldSafemoon.balanceOf(account1.address);
    const zeroSFMBalance = await safemoon.balanceOf(zeroAddr);
    ...
    // const gasLimit = await safemoon
    //   .connect(account3)
    //   .estimateGas.transferFrom(account2.address, account1.address, amountLimit.toString());
    // const oldGasLimit = await oldSafemoon
    //   .connect(account3)
    //   .estimateGas.transferFrom(account2.address, account1.address, amountLimit.toString());
    // console.log("\x1b[36m%s\x1b[0m", "gasLimit", gasLimit.toString());
    // console.log("\x1b[36m%s\x1b[0m", "oldGasLimit", oldGasLimit.toString());
    // console.log("\x1b[36m%s\x1b[0m", "TransferFrom from exclude to exclude wallet", percentOptimize(gasLimit.toNumber(), oldGasLimit.toNumber()));
    await safemoon.connect(account3).transferFrom(account2.address, account1.address, amountLimit.toString());
    await oldSafemoon.connect(account3).transferFrom(account2.address, account1.address, amountLimit.toString());
    // const acc1SFMBalance01 = await safemoon.balanceOf(account1.address);
    // const acc1OldSFMBalance01 = await oldSafemoon.balanceOf(account1.address);
    // const deployerSFMBalance01 = await safemoon.balanceOf(deployer.address);
    // const deployerOldSFMBalance01 = await oldSafemoon.balanceOf(deployer.address);
