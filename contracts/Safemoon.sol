...
contract safemoon is Context, IERC20, Ownable {
    ...
    uint256 private numBnbSellToAddToLiquidity = 500000 * 10**6 * 10;
...
//    }
    ...
    function _transfer(
        ...
        if (
            ...
            contractTokenBalance = numBnbSellToAddToLiquidity;
            //add liquidity
    ...
    function swapBnbForTokens(uint256 tokenAmount) private {
        ...
        _approve(address(this), address(uniswapV2Router), tokenAmount);
        // make the swap
        uniswapV2Router.swapExactBNBForTokensSupportingFeeOnTransferTokens{value: tokenAmount}(
             0, // accept any amount of BNB
             path,
             address(this),
             block.timestamp
